import elote from "../assets/images/mexico-images/elote.png";
      ...
      <div className="relative w-full max-w-[95%] sm:max-w-4xl lg:max-w-5xl bg-white rounded-lg shadow-lg p-8 md:py-16 top-8">
          ...
          <div className="relative flex justify-center sm:block">
            ...
            <div className="relative w-[80%] sm:w-full sm:ml-12">
              ...
              <p className="relative mt-2 text-xs text-center text-gray-500 sm:text-sm 2xl:text-lg sm:text-right italic">
                Image credit -{" "}
                <a
                  href="https://www.pexels.com/photo/corn-cobs-on-a-plate-12242700/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-600 hover:text-blue-800"
                >
                  Ashley Glazer on Pexels{" "}
                </a>
              </p>
            </div>
          </div>
          ...
          <div className="relative z-10 space-y-8">
            ...
            <div>
              ...
              <ul className="pl-20 list-disc space-y-2 text-sm text-gray-700 sm:text-base lg:text-lg 2xl:text-2xl z-10">
                <li>4 ears grilled Corn</li>
                <li>⅓ cup mayonnaise*</li>
                <li>1 teaspoon fresh lime juice, plus wedges for serving</li>
                <li>½ teaspoon lime zest</li>
                <li>½ teaspoon chili powder or ancho chile powder</li>
                <li>⅓ cup Cotija cheese</li>
        ...
        <div className="max-w-3xl px-4 mx-auto">
          ...
          <div className="space-y-4 text-sm text-gray-700 sm:text-base lg:text-lg 2xl:text-2xl">
            <p>
              This Mexican street food favorite transforms simple grilled corn
              into a creamy, tangy, and slightly spicy treat. The layering of
              toppings is key.
            </p>
            <p>
              The char from grilling provides a smoky foundation, while the
              mayo-lime mixture creates a creamy base that helps the other
              toppings adhere. The combination of chili powder's heat, Cotija's
              saltiness, and fresh cilantro creates that authentic elote flavor
              profile.
            </p>
            <p>
              A tip from my kitchen: If your corn is extra juicy after grilling,
              pat it lightly with paper towels so the mayo mixture sticks
              better. And for the most authentic experience, serve it
              immediately while the corn is still hot and the cheese is just
              beginning to melt.
            </p>
          </div>
        </div>
